...
/*
	The source code repository for numberstr.go is located at:
			https://github.com/MikeAustin71/numberstr_go.git
*/
...
// NewNumberStr - Creates, initializes and returns a
// new instance of 'NumberStr' based on a string of
// numeric digits passed as input parameter,
// 'numberStr'.
//
func(numStr NumberStr) NewNumberStr(
	numberStr string) (NumberStr, error) {

		ePrefix := "NumberStr.NewNumberStr() "
		numberStr1 := NumberStr{}.New()

		newNumberStr, err := numberStr1.ParseNumStr(numberStr)

		if err != nil {
			return NumberStr{},
				fmt.Errorf(ePrefix +
					"Error returned from numberStr1.ParseNumStr(numberStr). " +
					"numberStr='%v' Error='%v' ", numberStr, err.Error())
		}
